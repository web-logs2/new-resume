...
export const ProjectConstant = {
    ...
    projects: [
        ...
        { title: "大转盘", desc: ['钱包APP的大转盘抽奖功能。'] },
        { title: "折扣券", desc: ['在钱包APP已有的支付功能中加入可选折扣券，调整支付流程。'] },
        { title: "KYC", desc: ['钱包APP中用户录入个人信息的功能'] },
        { title: "线下扫码支付", desc: ['钱包APP的线下门店扫码支付功能'] },
        { title: "钱包APP组件库", desc: ['专用于钱包APP的组件库，开发了list、input、dialog、toast、drawer、progress等组件'] },
        { title: "批量代发", desc: ['批量代发全称为批量代发工资，是BO中后台提供的功能。入驻商家可以通过该功能在BO平台上给员工分发工资。'] },
    ]
}
